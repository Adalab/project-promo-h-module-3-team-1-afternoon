    ...
    <div className="view-hidden" id="toggle">
      ...
      <form className="create__design--form">
        <div className="colormix">
          ...
          <input className="color__one" id="color-one-selected" type="radio" value="1" name="COLORES" onClick={updatePaletteColor} />
        ...
        <div className="colormix">
          ...
          <input className="color__two" id="color-two-selected" type="radio" value="2" name="COLORES" onClick={updatePaletteColor} />
        ...
        <div className="colormix">
          ...
          <input className="color__three" id="color-three-selected" type="radio" value="3" name="COLORES" onClick={updatePaletteColor} />
