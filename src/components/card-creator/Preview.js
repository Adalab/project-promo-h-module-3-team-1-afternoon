        ...
        <section className="preview blue">
          ...
          <div className="preview__card">
            <div className="preview__content">
              <h1 className="preview__content__title" id="js-title">{this.props.userData.name === '' ? "Nombre Apellido" : this.props.userData.name}</h1>
              <p className="preview__content__text" id="js-job">{this.props.userData.job === '' ? "Front-end Developer" : this.props.userData.job}</p>
            </div>
            {this.props.children}
            <img className="preview__image" src={this.props.urlImage} />
